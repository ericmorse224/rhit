function model_b(fileName, K, Zeta, Omega_N)
%model_b   Read data from fileName and fit it to a model
%
...
%             K       = static gain
%             Zeta     = Damping Ratio
%             Omega_N = Natural Frequency in radians/second
%
